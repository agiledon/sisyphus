...
public class FixtureTest {
    @Test
    public void should_get_Type_data_with_yaml_format() {
    ...
    @Test
    public void should_get_Type_data_from_cache_with_yaml_format() {
        Map<String, List<String>> types = from("type.yaml").to(Map.class);
        assertThat(types, not(nullValue()));
    ...
    @Test
    public void should_get_User_data_with_json_format() {
    ...
    @Test
    public void should_get_User_data_with_gson_format() {
    ...
    @Test
    public void should_get_User_data_from_cache_with_json_format() {
    ...
    @Test
    public void should_get_StandardVariables_data_with_json_format() {
    ...
    @Test
    public void should_get_StandardVariables_data_with_gson_format() {
    ...
    @Test
    public void should_get_User_data_from_cache_with_gson_format() {
        StandardVariable[] standardVariables = from("standardVariable.gson").to(StandardVariable[].class);
        assertThat(standardVariables, not(nullValue()));
